...
// zooAnimals.forEach(function(creatureNames){
//   displayNames.push(`Names: ${creatureNames.animal_name} Scientific: ${creatureNames.scientific_name}`)
// })
...
// zooAnimals.filter(function(lessThanFive){
//   lessThanFive.population < 5
// })
...
populationTotal = zooAnimals.reduce(function (animalTotal, element) {
  return animalTotal + element.population
}, 0);
